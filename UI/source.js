...
var tags = ['Беларусь', 'Литва', 'Россия', 'Украина', 'Латвия', 'Польша', 'Авто', 'Проишествия', 'Спорт', 'Строительство', 'Культура', 'Афиша', 'Политика', 'Экономика', 'Туризм', 'Образование', 'Университет', 'Наука'];
...
function getArticles(skip=0, top=10,filterConfig = ''){
	...
	if(filterConfig.tag!= undefined)
		...
		var flag = filterConfig.tag.every(function(item){
			return obj.tag.join(' ').includes(item);
			})
		return flag;
		});
...
function validateArticle(article){
	if(article.id == '' || getArticle(article.id) != false || article.id == undefined)
		return false;
	if(article.title == '' || article.title.length >=100 || article.title == undefined)
		return false;
	if(article.summary.length =='' ||article.summary.length >=200 || article.summary == undefined)
		return false;
	if(article.createdAt == undefined)
		return false;
	if(article.content =='' || article.content == undefined)
		return false;
	if(article.author == '' || article.content == undefined)
		return false;
	if(!article.tag.every(function(item){
		var pos = tags.indexOf(item);
		return pos != -1;
	}))
		return false;
	return true;
...
function editArticle(id, article){
	...
	articles[pos].title = article.title;
	articles[pos].summary = article.summary;
	articles[pos].content = article.content;
	articles[pos].tag = article.tag;
	return true;
}
...
test= getArticles(0,10);
log(test);

console.log('getArticles(10,0)')
test= getArticles(10,1);
log(test);

console.log('getArticles(0,2,{createdAt: new Date(2017,1,28)})')
test =getArticles(0,2,{createdAt: new Date(2017,1,28)});
log(test);

console.log('getArticles(0,10,{tag:[ "Беларусь"]})')
test =getArticles(0,10,{tag: ["Беларусь"]});
log(test);


console.log('getArticles(0,10,{tag:["Беларусь", "Наука"]})')
test =getArticles(0,10,{tag: ["Беларусь", "Наука"]});
log(test);
*/

/*
console.log('Test getArticle');

console.log('test = getArticle(1)');
test = getArticle(1);
console.log(test);
console.log('test = getArticle(2)');
test = getArticle(2);
console.log(test);
console.log('test = getArticle(100)');
test = getArticle(100);
console.log(test);
*/

/*
console.log('Test removeArticle');
...
/*
console.log('Test addArticle and validateArticle');

console.log('Valide article, id = 21')
var r = addArticle({id: '21',title: 'В Светлогорске пятилетний мальчик самостоятельно открыл балкон и упал с третьего этажа', author: 'Иванов Иван', createdAt: new Date('2017-03-06T14:15:00'), summary:'О том, что под окнами 113-й малосемейки в Молодежном микрорайоне лежит ребенок, сообщили прохожие. На место немедленно прибыли скорая и милиция', content: 'Женщина, воспитывающая сына одна, пошла к знакомым, чтобы постирать белье — своей стиральной машины в семье нет. Она уложила сына спать, закрыла балконную дверь, а съемную ручку от нее спрятала.\nДома хозяйки не было больше часа. В это время и произошел несчастный случай: пятилетний мальчик нашел ручку, вышел на балкон и упал с третьего этажа. Ребенок остался жив. После тщательного обследования медики диагностировали перелом бедра. Мальчик находится в реанимации, состояние стабильно тяжелое.\nВ инспекции по делам несовершеннолетних рассказали, что ребенок состоит на учете в отделе образования как признанный находящимся в социально опасном положении из-за материальных трудностей в семье.\nПо факту случившегося проводится проверка.', tag: ['Проишествия']});
console.log(r);
log(articles);

console.log('Unvalide article(title), id = 22')
var r = addArticle({id: '22',title: '', author: 'Иванов Иван', createdAt: new Date('2017-03-06T14:15:00'), summary:'О том, что под окнами 113-й малосемейки в Молодежном микрорайоне лежит ребенок, сообщили прохожие. На место немедленно прибыли скорая и милиция', content: 'Женщина, воспитывающая сына одна, пошла к знакомым, чтобы постирать белье — своей стиральной машины в семье нет. Она уложила сына спать, закрыла балконную дверь, а съемную ручку от нее спрятала.\nДома хозяйки не было больше часа. В это время и произошел несчастный случай: пятилетний мальчик нашел ручку, вышел на балкон и упал с третьего этажа. Ребенок остался жив. После тщательного обследования медики диагностировали перелом бедра. Мальчик находится в реанимации, состояние стабильно тяжелое.\nВ инспекции по делам несовершеннолетних рассказали, что ребенок состоит на учете в отделе образования как признанный находящимся в социально опасном положении из-за материальных трудностей в семье.\nПо факту случившегося проводится проверка.', tag: ['Проишествия']});
console.log(r);
log(articles);

console.log('Unvalide article(tags), id = 23')
var r = addArticle({id: '23',title: '', author: 'Иванов Иван', createdAt: new Date('2017-03-06T14:15:00'), summary:'О том, что под окнами 113-й малосемейки в Молодежном микрорайоне лежит ребенок, сообщили прохожие. На место немедленно прибыли скорая и милиция', content: 'Женщина, воспитывающая сына одна, пошла к знакомым, чтобы постирать белье — своей стиральной машины в семье нет. Она уложила сына спать, закрыла балконную дверь, а съемную ручку от нее спрятала.\nДома хозяйки не было больше часа. В это время и произошел несчастный случай: пятилетний мальчик нашел ручку, вышел на балкон и упал с третьего этажа. Ребенок остался жив. После тщательного обследования медики диагностировали перелом бедра. Мальчик находится в реанимации, состояние стабильно тяжелое.\nВ инспекции по делам несовершеннолетних рассказали, что ребенок состоит на учете в отделе образования как признанный находящимся в социально опасном положении из-за материальных трудностей в семье.\nПо факту случившегося проводится проверка.',tag:['btj', 'Проишествия'] });
console.log(r);
log(articles);
*/

/*
console.log('Test editArticle and validateArticle')
console.log('Valid changes. Title, date, tags have changed')
console.log('Before');
console.log(getArticle(4));
var r = editArticle(4,{id: '4',title: 'Минтруда: в Беларуси пересмотрят назначение и выплату пособий', author: 'Иванов Иван', createdAt: new Date('2017-02-06T11:15:00'), summary:'Система назначения и выплат пособий в Беларуси будет усовершенствована', content:'По его словам, подготовлен в новой редакции проект закона «О государственных пособиях семьям, воспитывающим детей». Документ был принят в первом чтении и сейчас готовится ко второму чтению в Палате представителей Национального собрания.\nКак заявил замминистра, новой редакцией предусматриваются определенные меры усиления социальной поддержки семей, воспитывающих детей-инвалидов.\n— В частности документ дает возможность родителям, осуществляющим уход за детьми-инвалидами, работать на 0,5 ставки с сохранением пособия по уходу, — пояснил Александр Румак.\nСейчас право на такое пособие имеют неработающие и не получающие пенсии мать, отец, усыновитель (удочеритель), опекун, попечитель или другое лицо, фактически осуществляющее уход за ребенком-инвалидом. Кроме того, пособие по уходу за ребенком-инвалидом в возрасте до 18 лет могут также получать мать, отец, усыновитель (удочеритель), опекун, попечитель, находящиеся в отпуске по уходу за ребенком до достижения им возраста 3 лет. Предполагается, что после вступления изменений в силу родители детей-инвалидов сохранят право на пособие при выходе на работу не более чем на 0,5 ставки или при работе на дому.\nАлександр Румак также рассказал, что семьям, в которых воспитываются дети с 3-й и 4-й степенями утраты здоровья, будут увеличены пособия. Представитель Минтруда отметил, что количество семей, воспитывающих двух и более детей, в Беларуси продолжает расти. «На сегодня 57,2% рожденных детей являются вторыми или последующими», — сказал он, добавив, что всего в центрах социального обслуживания находятся на учете 88,5 тысячи многодетных семей.', tag:['Экономика']});
console.log('After');
console.log(r);
log(articles);

console.log('Unvalid changes. Tags does not exist')
console.log('Before');
console.log(getArticle(4));
var r = editArticle(4,{id: '4',title: 'Минтруда: в Беларуси пересмотрят назначение и выплату пособий детям инвалидам', author: 'Иванов Иван', createdAt: new Date('2017-02-06T11:15:00'), summary:'Система назначения и выплат пособий в Беларуси будет усовершенствована', content:'По его словам, подготовлен в новой редакции проект закона «О государственных пособиях семьям, воспитывающим детей». Документ был принят в первом чтении и сейчас готовится ко второму чтению в Палате представителей Национального собрания.\nКак заявил замминистра, новой редакцией предусматриваются определенные меры усиления социальной поддержки семей, воспитывающих детей-инвалидов.\n— В частности документ дает возможность родителям, осуществляющим уход за детьми-инвалидами, работать на 0,5 ставки с сохранением пособия по уходу, — пояснил Александр Румак.\nСейчас право на такое пособие имеют неработающие и не получающие пенсии мать, отец, усыновитель (удочеритель), опекун, попечитель или другое лицо, фактически осуществляющее уход за ребенком-инвалидом. Кроме того, пособие по уходу за ребенком-инвалидом в возрасте до 18 лет могут также получать мать, отец, усыновитель (удочеритель), опекун, попечитель, находящиеся в отпуске по уходу за ребенком до достижения им возраста 3 лет. Предполагается, что после вступления изменений в силу родители детей-инвалидов сохранят право на пособие при выходе на работу не более чем на 0,5 ставки или при работе на дому.\nАлександр Румак также рассказал, что семьям, в которых воспитываются дети с 3-й и 4-й степенями утраты здоровья, будут увеличены пособия. Представитель Минтруда отметил, что количество семей, воспитывающих двух и более детей, в Беларуси продолжает расти. «На сегодня 57,2% рожденных детей являются вторыми или последующими», — сказал он, добавив, что всего в центрах социального обслуживания находятся на учете 88,5 тысячи многодетных семей.', tag:['Финансы']});
console.log('After');
console.log(r);
log(articles);
*/
...
console.log('removeArticle(0)')
test= removeArticle(0);
console.log(test);
log(articles);

console.log('removeArticle("1")')
test= removeArticle("1");
console.log(test);
log(articles);

console.log('removeArticle(2)')
test= removeArticle(2);
console.log(test);
log(articles);
*/
